...
class Tailor(models.Model):
    ...
    multi_odoo_versions = fields.One2many('modules.tracker.odoo.versions', 'module_id', "Odoo Versions")
    ...
    odoo_store_link = fields.Char(string=_("Odoo Store Link"))


class OdooVersions(models.Model):
    _name = 'modules.tracker.odoo.versions'
    _description = 'Store Odoo Versions'
    _rec_name = 'odoo_version'

    odoo_version = fields.Char(string=_('Odoo Version'), required=True)
